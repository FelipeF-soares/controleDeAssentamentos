...
<body>
    <div class="container">
      ...
      <div class="card">
        <h5 class="card-header">Assentamento Registrado Com Sucesso!</h5>
        <div class="card-body">
          ...
          <p class="card-text">Nascimeto: <fmt:formatDate pattern="dd/MM/yyyy" value="${nascimentoFormatt}"/> RE: ${assentamento.re} Caixa: ${assentamento.caixa}</p>
