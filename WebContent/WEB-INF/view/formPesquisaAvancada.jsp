...
<c:url value="/acao=novo" var="linkNovoAssentamento"></c:url>
<c:url value="/entrada?acao=PesquisaAvancada" var="linkPesquisaAvancada"></c:url>
...
<body>
    ...
    <form class="row gy-2 gx-3 align-items-center" action="${ linkPesquisaAvancada }" method="post">
        <div class="col-auto">
